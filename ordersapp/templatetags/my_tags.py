...
register.filter('media_folder_products', media_folder_products) # регистрация тэга



@register.filter(name='media_folder_users') # регистрация тэга с помощью декоратора
